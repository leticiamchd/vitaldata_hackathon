...
st.write("Files in the vitaldata_hackathon directory:", os.listdir('vitaldata_hackathon'))

try:
    image_button_aprov = Image.open('vitaldata_hackathon/button_apr.png')
    image_button_neg = Image.open('vitaldata_hackathon/button_neg.png')
    image_button_pend = Image.open('vitaldata_hackathon/button_pend.png')
    image = Image.open('vitaldata_hackathon/banner.png')
