...
image_button_aprov = Image.open('/mount/src/vitaldata_hackathon/button_apr.png')
image_button_neg = Image.open('/mount/src/vitaldata_hackathon/button_neg.png')
image_button_pend = Image.open('/mount/src/vitaldata_hackathon/button_pend.png')
image = Image.open('/mount/src/vitaldata_hackathon/banner.png')
